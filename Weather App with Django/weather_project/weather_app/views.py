...
def index(request):
    api_key = '76f8622f1f32a40ba1bd60ee6a8cd4fb'
    current_weather_url = 'https://api.openweathermap.org/data/2.5/weather?q={}&appid={}'
    # Forcast documentation: https://openweathermap.org/forecast5#5days
...
def fetch_weather_and_forecast(city, api_key, current_weather_url, forecast_url):
    ...
    for daily_data in forecast_response['list'][:5]:
        daily_forecasts.append({
            'day': datetime.datetime.fromtimestamp(daily_data['dt']).strftime('%A %H:%M'),
